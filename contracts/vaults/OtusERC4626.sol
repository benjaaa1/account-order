...
abstract contract OtusERC4626 is ERC4626Upgradeable {
    using SafeERC20 for IERC20Metadata;
    using FixedPointMathLib for uint256;

    struct OtusERC4626InitParams {
    ...
    function __OtusERC4626_init(OtusERC4626InitParams memory params) internal {
    ...
    function _simulateBeforeWithdraw(
        uint256 assets
    ) internal view virtual returns (uint256 adjustedAssets, int256 tokensToTrade);
